...
contract StreamityCrowdsale is Pauseble
{
    ...
    */
    ...
    {
        uint256 _amount = (amount / buyPrice) * DEC; /// данная строка вызывает ошибку при переислении менее 1 эфира - возникает дробная часть, в solidity не предусмотреннная - предлагаю заменить на  - uint256 _amount = amount.mul(DEC).div(buyPrice);
